diff --git a/pages/02_📂_Portfolios.py b/pages/02_📂_Portfolios.py
index c5bcf8112d9728fc8e41b8850548f30d6b03e024..07d67dfe2f27c986991f7c65be976e1b086c6559 100644
--- a/pages/02_📂_Portfolios.py
+++ b/pages/02_📂_Portfolios.py
@@ -1,47 +1,55 @@
 import json
+import re
...
@@ -203,108 +211,292 @@ def build_portfolio_history(holdings_df: pd.DataFrame, period="6mo", interval="1
